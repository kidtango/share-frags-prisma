...
exports.Prisma.LivestockScalarFieldEnum = makeEnum({
  id: 'id',
  name: 'name',
  price: 'price',
...
exports.Prisma.LivestockWishlistScalarFieldEnum = makeEnum({
  userId: 'userId',
...
exports.Prisma.ShopReviewScalarFieldEnum = makeEnum({
  text: 'text',
  rating: 'rating',
  shopId: 'shopId',
  userId: 'userId'
...
exports.Prisma.ShopLikeScalarFieldEnum = makeEnum({
  userId: 'userId',
  shopId: 'shopId'
});
